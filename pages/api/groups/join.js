...
export default async function handler(req, res) {
    if (req.method === 'POST') {
      ...
      try {
        ...
        const results = await pool.promise().query('SELECT * FROM groups WHERE group_id = ?', [groupName]);
        ...
        await pool.promise().query('INSERT INTO participants (group_id) VALUES (?)', [groupName]);
